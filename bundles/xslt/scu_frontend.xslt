...
<xsl:choose>
  ...
  <script language='javascript'
    ...
    <body class="clearfix" onLoad="ss_sf();" dir="ltr">
	<div id="container" class="schoolpage">
	  <xsl:call-template name="header_element"/>
	  <xsl:call-template name="main_content_wrapper_start"/>
      <div class="main-content">
...
<body class="clearfix" onload="setFocus()" dir="ltr">
  <div id="container" class="schoolpage">
...
<body class="clearfix" onload="{$only_apps_onload}">
<div id="container" class="schoolpage">
              ...
              <xsl:choose>
                ...
                <xsl:when test="$show_suggest = '1' and (($type = 'home') or ($type = 'std_top'))">
                  <div id="query_suggestions_div">
                    <input type="text" name="q" class="q search-box" size="{$search_box_size}" maxlength="256" value="{$space_normalized_query}" autocomplete="off" />
                  <xsl:choose>
                      <xsl:when test="$choose_search_button = 'image'">
                                <input type="image" name="btnG" src="{$search_button_image_url}"
                               valign="bottom" width="60" height="26"
                ...
                <xsl:otherwise>
                  <input type="text" name="q" class="q search-box" size="{$search_box_size}" maxlength="256" value="{$space_normalized_query}"/>
                </xsl:otherwise>
              </xsl:choose>
        <br/>
        <div id="last_div_secure">
            <xsl:if test="$show_secure_radio != '0'">
                <font size="-1">Search:
                  <xsl:choose>
                    <xsl:when test="$access='p'">
...
<div id="sort_by_div" class="pull-right sort-by">
  <span class="s">
<xsl:choose>
...
<div id='clustering'>
  <h3><span class="caps">narrow</span> your search</h3>
